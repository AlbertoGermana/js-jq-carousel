...
impaginazione più bella;
transizioni tra il cambio img;
varie di fantasia */
...
$(document).ready(function(){
  ...
  $(document).keydown(
    function(keyPushed){
      if(keyPushed.keyCode == 37){ //se il tasto è 37 (freccia sinistra)
        prevImg(); //esegui
      }else if(keyPushed.keyCode == 39){ //se il tasto è 39 (freccia destra)
        nextImg(); //esegui
      }
    }
  )
